...
export const metadata: Metadata = {
  title: "Turnos · Matter Club",
  description:
    "Mirá los horarios libres de la semana en Matter Club y pedí tu turno de 2 horas.",
};
  ...
  return (
    <>
      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-4 py-10 sm:px-6">
        <div className="mb-8">
          <p className="text-xs uppercase tracking-[0.3em] text-bordo-2">Turnero</p>
